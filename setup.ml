...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3853e41442a9c490e8de637df8bfe675) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ciso_worker"];
                      lib_pack = false;
                      lib_internal_modules = ["Opam"];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "ciso"; FindlibPackage ("lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   },
                   {
                      lib_modules = ["Master"];
                      lib_pack = false;
                      lib_internal_modules = ["Scheduler"; "Monitor"];
                      lib_findlib_parent = Some "ciso";
                      lib_findlib_name = Some "master";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "store_main.ml"});
               Executable
                 ({
                     cs_name = "ciso-worker";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "worker_main.ml"});
               Executable
                 ({
                     cs_name = "ciso-master";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "master_main.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ç\153\159\136uAü\133\002É«Zfª+¹";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
