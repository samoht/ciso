...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6b0d89cab5dc5c04e2702155b08d0cd2) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("Ci_opam", None);
                           FindlibPackage ("Scheduler", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "|\002\213\021Xg\180_2\173TA\208\207&l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
