...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3d3641250fe8d56f872af3315ba81eb8) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Object"; "Task"; "Message"; "Host"; "Common_types"];
                      lib_pack = false;
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ci_basic";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "store_server.ml"});
               Executable
                 ({
                     cs_name = "worker";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "worker.ml"});
               Executable
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cmdliner", None);
                           FindlibPackage ("uri", None);
                           FindlibPackage ("opam-lib.solver", None);
                   ...
                   {exec_custom = true; exec_main_is = "master.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\238f\202\225\127\134\\\r1\170<lL\152\246\216";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
