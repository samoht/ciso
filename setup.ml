...
(* OASIS_START *)
(* DO NOT EDIT (digest: ac330320125225cba4766929faa3de17) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ciso", ["-q"]))];
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("jsont.jsonm", None);
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ciso";
                           FindlibPackage ("irmin.unix", None);
                           FindlibPackage ("opam-lib.client", None);
                   ...
                   {
                      lib_modules = ["Task_worker"; "Job_worker"];
                      lib_pack = false;
                      lib_internal_modules = ["Opam"; "Common_worker"];
                      lib_findlib_parent = Some "ciso";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ciso_list.ml"});
               Executable
                 ({
                     cs_name = "ciso-work";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ciso_work.ml"});
               Executable
                 ({
                     cs_name = "ciso-schedule";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "ciso_schedule.ml"});
               Executable
                 ({
                     cs_name = "ciso-add";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ciso_add.ml"});
               Executable
                 ({
                     cs_name = "ciso-publish";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "ciso_publish.ml"});
               Executable
                 ({
                     cs_name = "ciso";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ciso.ml"});
               Library
                 ({
                     cs_name = "ciso-github";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\\\022\003¹ÑÈ\133²0zÚ_\129º»ö";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
