...
(* OASIS_START *)
(* DO NOT EDIT (digest: fa5f502d2f7f47f892dc62ca12c19f69) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ciso_worker.ml"});
               Executable
                 ({
                     cs_name = "ciso-scheduler";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "ciso_scheduler.ml"});
               Executable
                 ({
                     cs_name = "ciso-add";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ciso_store.ml"});
               Library
                 ({
                     cs_name = "ciso-github";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "æ\\\148Ï\020\031\156\157IAÆ\027\002BÓ±";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
